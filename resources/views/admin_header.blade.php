        ...
        <div class="right-menu list-inline no-margin-bottom">
          ...
          <div class="list-inline-item dropdown">
            <a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle">
              <img src="./admincss/img/English icon.jpg" alt="English" style="width: 24px; height: 24px; margin-right: 5px;">
            ...
            <div aria-labelledby="languages" class="dropdown-menu">
              <a rel="nofollow" href="#" class="dropdown-item" onclick="changeLanguage('Bangla')">
                <img src="./admincss/img/Bangla icon.jpg" alt="Bangla" style="width: 24px; height: 24px; margin-right: 5px;">
                <span>Bangla</span>
              </a>
            </div>
          </div>
